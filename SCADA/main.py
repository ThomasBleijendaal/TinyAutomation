...
general.Objects.addObject("QT_insideHumidity", AI.AnalogInput("Inside humidity","%r",0,6,1))
general.Objects.addObject("QT_outsideHumidity", AI.AnalogInput("Outside humidity","%r",1,6,6))
general.Objects.addObject("TT_inside", AI.AnalogInput("Inside temperature","°C",2,14,1))
general.Objects.addObject("TT_outside", AI.AnalogInput("Outside temperature","°C",3,14,6))
general.Objects.addObject("PT_atmosphere", AI.AnalogInput("Pressure","mbar",4,22,1))
general.Objects.addObject("TT_atmosphere", AI.AnalogInput("Temperature","°C",5,22,6))
general.Objects.addObject("QT_light", AI.AnalogInput("Light sensor","%",6,6,11))
general.Objects.addObject("QT_light2", AI.AnalogInput("Light sensor","%",7,14,11))
